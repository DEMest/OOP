...
import ru.nsu.smolin.checker.pipeline.BuildStep;
import ru.nsu.smolin.checker.pipeline.GitCloneStep;
import ru.nsu.smolin.checker.pipeline.GradeStep;
import ru.nsu.smolin.checker.pipeline.Pipeline;
import ru.nsu.smolin.checker.pipeline.Step;
import ru.nsu.smolin.checker.pipeline.StepContext;
import ru.nsu.smolin.checker.pipeline.StyleStep;
import ru.nsu.smolin.checker.pipeline.TaskReport;
import ru.nsu.smolin.checker.pipeline.TestsStep;
...
import ru.nsu.smolin.checker.tools.ProcessRunner;
import ru.nsu.smolin.checker.tools.RealProcessRunner;
